...
def work_analysis(simResult, params, protocol_list):
    ...
    print(f"phi_1dcx_on: {params['circuit_parameters']['phi_1_dcx_on']}, phi_2dcx_on: {params['circuit_parameters']['phi_2_dcx_on']}, M_12_on: {params['circuit_parameters']['M_12_on']}")
...
def work_done_of_each_type(simResult):
    ...
    ["01", "11", "00", "10"]
    ax_flatten[0].hist(simResult["work_distribution"][index_of_01], bins = 30, label = "01")
    ax_flatten[0].set_title(f"mean of 01 = {np.mean(simResult['work_distribution'][index_of_01]):.3g}")
    ax_flatten[1].hist(simResult["work_distribution"][index_of_11], bins = 30, label = "11")
    ax_flatten[1].set_title(f"mean of 11 = {np.mean(simResult['work_distribution'][index_of_11]):.3g}")
    ax_flatten[2].hist(simResult["work_distribution"][index_of_00], bins = 30, label = "00")
    ax_flatten[2].set_title(f"mean of 00 = {np.mean(simResult['work_distribution'][index_of_00]):.3g}")
    ax_flatten[3].hist(simResult["work_distribution"][index_of_10], bins = 30, label = "10")
