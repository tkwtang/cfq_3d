...
experiment_comment = "Experiment 1 (2025-1-31): To study the trade-off between speed and work done, and also speed and fidelity CE_t_factor = 5.0, dt = 1/500, multiple 100 times"
...
t_factor_CE_protocol = 5
CE_t_1, CE_t_2, CE_t_3 = 100, 200, 100
...
simResult = cfq_batch_sweep.simulateSingleCoupledFluxQubit(params, initial_parameter_dict, protocol_list, potential = coupled_fq_pot, potential_default_param = coupled_fq_default_param, mapping_state_1_to_state_2_dict = mapping_dict, initial_state = init_state_used, manual_domain = manual_domain, phi_1_dcx = phi_1_dcx,  phi_2_dcx = phi_2_dcx, measure_all_states=saveAllStates, has_velocity = has_velocity, pickle_save_path = pickle_save_path)
