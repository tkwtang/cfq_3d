...
parameter_choice_array = ["chris", "squeeze_by_phi_2xdc", "squeeze_by_L", "experiment"]
parameter_choosen = parameter_choice_array[-1]

apply_KE_extraction_protocol = False
...
comment_of_simulation = "Experiment 2 (2024/10/18): squeeze by L and no KE extraction"

phi_1_x_on_12, phi_2_x_on_12, phi_1_dcx_on_12, phi_2_dcx_on_12, phi_1_x_on_21, phi_2_x_on_21, phi_1_dcx_on_21, phi_2_dcx_on_21, M_12_on, four_well, CE_1, CE_8, lower_H_wells, flip_H, lower_V_wells, flip_V, KE_extraction_protocol_for_CE_1, KE_extraction_protocol_for_CE_8 = choose_NAND_Parameter(parameter_choosen)
...
for _ in range(0, 25):
    ...
    for _dt in [1/100]:
        ...
        params['comment'] = comment_of_simulation 
        ...
        KE_extraction_protocol = {
            "phi_1_x": phi_1_x_on_12, "phi_2_x": 0.0, "M_12": 0.00, \
            "phi_1_dcx": phi_1_dcx_off, "phi_2_dcx": phi_2_dcx_on_12, "name":"KE_extraction_protocol"
        }
        if apply_KE_extraction_protocol:
            protocol_list = [
            ...
            protocol_list = [
                # THis is for original protocol
                # create_CE_Protocol(100, CE_1),
                # create_CE_Protocol(200, CE_1),
                # create_CE_Protocol(100, four_well)
            
                create_CE_Protocol(100, CE_1),
                create_CE_Protocol(10,  CE_1),
                create_CE_Protocol(100, four_well)
